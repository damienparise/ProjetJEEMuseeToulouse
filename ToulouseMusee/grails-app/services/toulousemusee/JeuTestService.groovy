...
class JeuTestService {
    ...
    def insertToMusee(){
        ...
        musee1 = museeService.insertOrUpdateMusee(new Musee(nom:"ARCHIVES MUNICIPALES TOULOUSE" , horairesOuverture: "Ouvert du lundi au vendredi de 9h Ã  17h. Fermeture de 12h Ã  13h30 pendant toutes les vacances scolaires. Fermeture annuelle la derniÃ¨re quinzaine de juillet." ,
                telephone: "05 61 61 63 33" , accesMetro: "Roseraie (A)", accesBus: "36, 38", isPrefere: false), adresse1, gestionnaire1)
        musee2 = museeService.insertOrUpdateMusee(new Musee(nom: "CMAV - CENTRE MERIDIONAL DE L'ARCHITECTURE DE LA VILLE", horairesOuverture: "Ouvert du mardi au samedi de 13h Ã  19hfermÃ© les dimanches, jours fÃ©riÃ©s et du 1er au 15 aoÃ»t", telephone: "05 61 23 30 49",
                accesMetro: "Capitole (A), Jean JaurÃ¨s (B)" , accesBus: "ncv, 2, 10, 12, 14, 38, 78 et 80", isPrefere: false), adresse2, gestionnaire2)
