	...
	<body>
		...
		<div id="show-musee" class="content scaffold-show" role="main">
			...
			<ol class="property-list musee">
				...
				<g:if test="${museeInstance?.adresseMusee}">
				<li class="fieldcontain">
					<span id="adresseMusee-label" class="property-label"><g:message code="musee.adresseMusee.label" default="Adresse Musee" /></span>
					
						<span class="property-value" aria-labelledby="adresseMusee-label"><g:link controller="adresse" action="show" id="${museeInstance?.adresseMusee?.id}">${museeInstance?.adresseMusee?.encodeAsHTML()}</g:link></span>
